...
# curium block #1
# moo@b1:~/.curium$ curiumd getblockhash 1
# 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# moo@b1:~/.curium$ curiumd getblock 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# {
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_curium_hash(self):
        self.pow_hash = hexlify(curium_hash.getPoWHash(self.block_header))
